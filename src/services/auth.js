...
export const getUserProfile = async () => {
  try {
    ...
    // Extracting role in addition to other fields
    const { first_name, last_name, email, username, profile_picture, is_verified, registration_date, role } = response.data;
    ...
    return {
      ...
      is_verified,
      registration_date,
      role,  // Including role fetched from the backend
    };
  } catch (error) {
